...
class VideoGenerator {
    constructor() {
        ...
        this.backgroundImages = {
            ...
            scifi: ['https://cdn.pixabay.com/photo/2017/08/10/02/05/tiles-shapes-2617112_1280.jpg'],
            mystery: ['https://cdn.pixabay.com/photo/2020/04/25/12/14/circle-5090539_1280.jpg'],
            romance: ['https://cdn.pixabay.com/photo/2017/07/24/12/43/schrecksee-2534484_1280.jpg'],
            horror: ['https://cdn.pixabay.com/photo/2016/10/20/18/35/earth-1756274_1280.jpg'],
            adventure: ['https://cdn.pixabay.com/photo/2016/08/11/23/48/mountains-1587287_1280.jpg'],
            historical: ['https://cdn.pixabay.com/photo/2017/07/01/19/48/background-2462431_1280.jpg']
        };
                ...
                const animate = () => {
                    ...
                    if (frameCount < this.videoSettings.fps * 5) {
                        ...
                        const sentenceIndex = Math.floor(
                            ((frameCount - this.videoSettings.fps * 5) / (totalFrames - this.videoSettings.fps * 5)) * sentences.length
                        );
    ...
    extractKeySentences(story) {
        ...
        story.chapters.forEach(chapter => {
            const chapterSentences = chapter.content
                .split(/[.!?]+/)
